...
const ARCS = [
  [51.5, -0.1, 40.7, -74, 0x00e5ff],
  [-6.2, 106.8, 35.7, 139.7, 0x5e5ce6],
  [48.8, 2.35, 55.75, 37.6, 0x00e5ff],
  [1.3, 103.8, 31.2, 121.5, 0xff453a],
  [40.7, -74, -23.5, -46.6, 0x5e5ce6],
  [37.6, 126.9, 28.6, 77.2, 0x00e5ff],
  [-33.9, 151.2, 1.3, 103.8, 0xff453a],
];
...
export default function Globe({ theme = 'cyan', size = 440 }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const primary = theme === 'cyan' ? 0x00e5ff : 0x5e5ce6;
      const secondary = theme === 'cyan' ? 0x5e5ce6 : 0x00e5ff;
