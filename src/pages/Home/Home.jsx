...
export default function Home() {
  const particlesRef = useParticles('0,229,255');
    ...
    dtAlert({
      ...
      html: `<p style="margin-bottom:18px">Siap menerima proyek baru. Hubungi melalui salah satu platform berikut.</p>
        <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;">
          ...
          <a href="${CONTACT.telegram}" target="_blank" style="padding:9px 20px;background:rgba(255,255,255,.07);color:#f0f0ff;border:1px solid rgba(0,229,255,.2);border-radius:50px;text-decoration:none;font-size:.84rem;">Telegram</a>
        </div>`,
  ...
  const showContact = () => {
    dtAlert({
      ...
      html: `<div style="display:grid;gap:10px;margin-top:8px;">
        ...
        <a href="${CONTACT.telegram}" target="_blank" style="display:flex;align-items:center;gap:12px;padding:13px 17px;background:rgba(0,229,255,.05);border:1px solid var(--border);border-radius:13px;text-decoration:none;color:#f0f0ff;font-weight:600;font-size:.88rem;">
        ...
        <a href="${CONTACT.email}" style="display:flex;align-items:center;gap:12px;padding:13px 17px;background:rgba(94,92,230,.05);border:1px solid rgba(94,92,230,.18);border-radius:13px;text-decoration:none;color:#f0f0ff;font-weight:600;font-size:.88rem;">
    ...
    <div ref={cardGlowRef}>
      ...
      <section className="stats-section">
        <div className="stats-grid">
          ...
          <StatCard icon={<FolderCheck size={22} />} target={10} label="Proyek Selesai" title="Proyek Selesai" desc="10+ proyek telah berhasil diselesaikan dengan kualitas premium." />
