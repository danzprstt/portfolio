...
import {
  ...
  ShieldCheck, Bot, CreditCard, LineChart, Boxes, AreaChart, AlertTriangle,
} from 'lucide-react';
          ...
          <div className="features-wrapper">
            ...
            {visibleFeatures.length === 0 ? (
              <div className="dash-alert">
                ...
                <span>Belum ada fitur pada status ini. Coba pilih filter lain.</span>
              </div>
            ) : (
                ...
                <svg width="100%" height="220" viewBox="0 0 320 220" preserveAspectRatio="xMidYMid meet">
                  <defs>
                    <linearGradient id="progress-area-fill" x1="0" y1="0" x2="0" y2="1">
                      ...
                      <stop offset="100%" stopColor="var(--p-live)" stopOpacity="0" />
                    </linearGradient>
                  </defs>
                  <line x1="40" y1="30" x2="300" y2="30" stroke="#2c2c2e" strokeWidth="1" />
                  <line x1="40" y1="80" x2="300" y2="80" stroke="#2c2c2e" strokeWidth="1" />
                  <line x1="40" y1="130" x2="300" y2="130" stroke="#2c2c2e" strokeWidth="1" />
                  <line x1="40" y1="170" x2="300" y2="170" stroke="#3a3a3c" strokeWidth="1" />

                  <path d="M 40 170 L 40 140 L 105 110 L 170 90 L 235 60 L 300 45 L 300 170 Z" fill="url(#progress-area-fill)" />
