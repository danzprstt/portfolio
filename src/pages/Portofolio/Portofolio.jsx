    ...
    dtAlert({
      ...
      html: `<p style="margin-bottom:16px">${skill.desc}</p>
        <div style="background:rgba(255,255,255,.06);border-radius:50px;height:9px;overflow:hidden;margin-bottom:8px;">
          <div style="height:100%;width:${skill.pct}%;background:linear-gradient(90deg,#00e5ff,#5e5ce6);border-radius:50px;transition:width 1.1s ease;"></div>
        </div>
        <div style="display:flex;justify-content:space-between;font-size:.76rem;color:#98989d;font-family:'JetBrains Mono',monospace;">
    ...
    dtAlert({
      ...
      html: `<p style="margin-bottom:14px;line-height:1.7">${project.detail}</p>
        <div style="display:flex;flex-wrap:wrap;gap:6px;justify-content:center;">
          ${project.tech.map((t) => `<span style="padding:3px 11px;background:rgba(0,229,255,.09);border:1px solid rgba(0,229,255,.2);border-radius:50px;font-size:.73rem;color:#00e5ff;font-family:'JetBrains Mono',monospace;">${t}</span>`).join('')}
        </div>`,
